...
function Translator() {
    ...
    return (
        ...
        <div className="wrapper-translator">
            <div className="text-input-translator">
                ...
                <textarea name="to" className="to-text-field" id="to" value={toText} readonly></textarea>
            </div>
        ...
        <button onClick={handleTranslate} disabled={loading} className='button-translator'>
